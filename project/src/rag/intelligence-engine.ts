...
export const FONT_REGISTRY: Record<LivelloFonte, FonteInfo[]> = {
  A: [
    ...
    { livello: 'A', nome: 'MIM', url: 'https://www.miur.gov.it/web/guest/home', peso: 100 },
  ...
  B: [
    { livello: 'B', nome: 'INVALSI', url: 'https://www.invalsicloud.it', peso: 95 },
    { livello: 'B', nome: 'INDIRE', url: 'https://www.indire.it', peso: 95 },
    { livello: 'B', nome: 'ISTAT', url: 'https://www.istat.it', peso: 95 },
    { livello: 'B', nome: 'USR Abruzzo', url: 'https://www.mim.gov.it/web/abruzzo', peso: 90 },
    { livello: 'B', nome: 'USR Basilicata', url: 'https://www.mim.gov.it/web/basilicata', peso: 90 },
    { livello: 'B', nome: 'USR Calabria', url: 'http://www.istruzione.calabria.it', peso: 90 },
    { livello: 'B', nome: 'USR Campania', url: 'https://www.mim.gov.it/web/miur-usr-campania', peso: 90 },
    { livello: 'B', nome: 'USR Emilia-Romagna', url: 'https://istruzioneer.gov.it', peso: 90 },
    { livello: 'B', nome: 'USR Friuli-Venezia Giulia', url: 'https://usrfvg.gov.it/it/home/index.html', peso: 90 },
    { livello: 'B', nome: 'USR Lazio', url: 'https://www.ufficioscolasticoregionalelazio.it', peso: 90 },
    { livello: 'B', nome: 'USR Liguria', url: 'https://www.istruzioneliguria.gov.it/', peso: 90 },
    { livello: 'B', nome: 'USR Lombardia', url: 'https://www.mim.gov.it/web/usr-lombardia/', peso: 90 },
    { livello: 'B', nome: 'USR Marche', url: 'https://www.mim.gov.it/web/miur-usr-marche', peso: 90 },
    { livello: 'B', nome: 'USR Molise', url: 'https://www.mim.gov.it/web/molise', peso: 90 },
    { livello: 'B', nome: 'USR Piemonte', url: 'http://www.istruzionepiemonte.it', peso: 90 },
    { livello: 'B', nome: 'USR Puglia', url: 'https://www.pugliausr.gov.it/', peso: 90 },
    { livello: 'B', nome: 'USR Sardegna', url: 'https://www.mim.gov.it/web/usr-sardegna', peso: 90 },
    { livello: 'B', nome: 'USR Sicilia', url: 'http://www.usr.sicilia.it', peso: 90 },
    { livello: 'B', nome: 'USR Toscana', url: 'https://www.mim.gov.it/web/miur-usr-toscana', peso: 90 },
  ...
  F: [
    ...
    { livello: 'F', nome: 'FLC CGIL', url: 'https://www.flcgcgil.it/feed/', peso: 60 },
    { livello: 'F', nome: 'CISL Scuola', url: 'https://www.cislscuola.it', peso: 60 },
    { livello: 'F', nome: 'UIL Scuola', url: 'https://uilscuolanazionale.it', peso: 60 },
...
export async function fetchKnowledgeGraph(newsId: string): Promise<KnowledgeLink[]> {
  try {
    const { data, error } = await supabase
      ...
      .select('*')
      .or(`news_id_a.eq.${newsId},news_id_b.eq.${newsId}`)
      .limit(20);
    if (!error && data) return data as KnowledgeLink[];
  } catch {}
  return [];
}

export function getMockKnowledgeGraph(): KnowledgeLink[] {
  return [];
}
